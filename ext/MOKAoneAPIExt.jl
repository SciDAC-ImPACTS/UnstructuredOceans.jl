...
MOKA.device!(::oneAPIGPU, i) = oneAPI.device!(i)

MOKA.architecture(::oneArray)            = oneAPIGPU()
MOKA.architecture(::Type{oneArray})      = oneAPIGPU()
MOKA.architecture(::oneDeviceArray)      = oneAPIGPU()
MOKA.array_type(::GPU{<:oneAPIBackend})  = oneArray

MOKA.on_architecture(::oneAPIGPU, a::Number)       = a
MOKA.on_architecture(::CPU, a::oneArray)           = Array(a)
MOKA.on_architecture(::oneAPIGPU, a::Array)        = oneArray(a)
MOKA.on_architecture(::oneAPIGPU, a::oneArray)     = a
MOKA.on_architecture(::oneAPIGPU, a::BitArray)     = oneArray(a)
MOKA.on_architecture(::oneAPIGPU, a::StepRangeLen) = a
...
MOKA.set_ad_device_heap!(::oneAPIGPU; bytes::Integer = 512 * 1024 * 1024) = nothing
MOKA.set_ad_device_heap!(::oneAPIBackend; bytes::Integer = 512 * 1024 * 1024) = nothing

end # module MOKAoneAPIExt
